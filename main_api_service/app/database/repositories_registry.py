...
class RepositoriesRegistry:
    def __init__(self, 
                ...
                external_business_postgres_repository: ExternalBusinessEntityPostgresRepositoryABC) -> None:
        ...
        self.external_business_postgres_repository = external_business_postgres_repository
