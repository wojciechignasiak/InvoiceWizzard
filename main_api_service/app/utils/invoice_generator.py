...
async def invoice_generator(
    ...
    <div class="invoice-from-data">
        ...
        <span class="invoice-from-entry">{seller_company_name}</span>
        <span class="invoice-from-entry">{seller_street}; {seller_postal_code} {seller_city}</span>
        <span class="invoice-from-entry">NIP {seller_nip_number}</span>
    </div>
    """
    ...
    <div class="invoice-client-data">
        ...
        <span class="invoice-client-entry">{buyer_company_name}</span>
        <span class="invoice-client-entry">{buyer_street}; {buyer_postal_code} {buyer_city}</span>
        <span class="invoice-client-entry">NIP {buyer_nip_number}</span>
    </div>
    """
    invoice_items_container = ""
    for invoice_item in invoice_items:
        vat_procent = ((invoice_item.gross_value - invoice_item.net_value) / invoice_item.net_value) * 100
